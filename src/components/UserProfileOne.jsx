            ...
            <div class="row no-gutters">
                ...
                <div class="profile-content-left profile-left-spacing pt-5 pb-3 px-3 px-xl-5">
                    ...
                    <div class="card-body">
                        ...
                        <Link class="btn btn-primary btn-pill btn-lg my-4" to="#">Follow</Link>
                    </div>
                    </div>
                    ...
                    <p class="pb-3 social-button">
                        <Link to="#" class="mb-1 btn btn-outline btn-twitter rounded-circle">
                        <i class="mdi mdi-twitter"></i>
                        </Link>

                        <Link to="#" class="mb-1 btn btn-outline btn-linkedin rounded-circle">
                        <i class="mdi mdi-linkedin"></i>
                        </Link>

                        <Link to="#" class="mb-1 btn btn-outline btn-facebook rounded-circle">
                        <i class="mdi mdi-facebook"></i>
                        </Link>

                        <Link to="#" class="mb-1 btn btn-outline btn-skype rounded-circle">
